# Multi-stage Dockerfile for herakles-proc-mem-exporter
...
ARG TARGETPLATFORM
COPY --chmod=755 herakles-proc-mem-exporter /usr/local/bin/herakles-proc-mem-exporter
